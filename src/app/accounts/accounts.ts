...
import { defineComponents, IgcButtonComponent, IgcDialogComponent, IgcDropdownComponent, IgcIconComponent, IgcInputComponent, IgcRippleComponent, IgcSelectComponent, IgcTextareaComponent } from 'igniteui-webcomponents';
import '@infragistics/igniteui-webcomponents-grids/grids/combined.js';
import { CustomersType } from '../models/Northwind/customers-type';
import { northwindService } from '../services/Northwind-service';

defineComponents(IgcButtonComponent, IgcIconComponent, IgcRippleComponent, IgcSelectComponent, IgcInputComponent, IgcDropdownComponent, IgcDialogComponent, IgcTextareaComponent);
...
export default class Accounts extends LitElement {
  ...
  constructor() {
    super();
    this.northwindCustomers = northwindService.getCustomers();
  }
    ...
    return html`
      ...
      <div class="row-layout group">
        <div class="column-layout group_1">
          <div class="column-layout group_2">
            <div class="row-layout header">
              <div class="row-layout page-title">
                <div class="row-layout group_3">
                  <img src="/src/assets/Accounts%20Icon%20-%20Green.svg" class="image" />
                </div>
                <h6 class="h6">
                  Accounts
                </h6>
              ...
              <div class="row-layout buttons">
                <igc-button variant="flat" type="button" @click="${() => this.newAccountDialog?.toggle()}" class="button button_2">
            ...
            <div class="row-layout filters-and-sorting">
              ...
              <div class="row-layout group_5">
                <igc-button variant="flat" type="button" id="button" @click="${() => this.dropdown?.toggle(this.button)}" class="button button_5">
          ...
          <igc-grid .data="${this.northwindCustomers}" primary-key="contactName" ?allow-filtering="${true}" filter-mode="excelStyleFilter" @click="${() => Router.go(`/account-sample`)}" class="ig-typography ig-scrollbar grid">
      ...
      <igc-dialog ?close-on-outside-click="${true}" id="new-account-dialog">
            ...
            <div class="column-layout group_8">
              ...
              <div class="row-layout group_9">
                <div class="column-layout group_10">
                  ...
                  <igc-textarea label="Description" ?outlined="${false}" class="user-input"></igc-textarea>
                </div>
                <div class="column-layout group_10">
        ...
        <div slot="footer">
          <igc-button variant="flat" type="button" @click="${() => this.newAccountDialog?.toggle()}" class="button_1">
            Cancel
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button type="button" @click="${() => this.newAccountDialog?.toggle()}" class="button_1 button_1_1">
            Save
            <igc-ripple></igc-ripple>
          </igc-button>
        </div>
