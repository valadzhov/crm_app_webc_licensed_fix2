...
export default class Home extends LitElement {
  ...
  constructor() {
    ...
    cRMAppDataService.getMeetingsTasksList().then(data => this.cRMAppDataMeetingsTasks = data);
  }
      ...
      <div class="row-layout group">
        <div class="column-layout group_1">
          ...
          <div class="column-layout group_3">
            ...
            <igc-grid .data="${this.northwindCustomers}" primary-key="customerID" ?allow-filtering="${true}" filter-mode="excelStyleFilter" class="ig-typography ig-scrollbar grid">
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item) => html`
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Account-List-Avatar-Icon.svg" shape="rounded" slot="start" class="avatar avatar_1"></igc-avatar>
                    <div>
          ...
          <div class="column-layout group_5">
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item) => html`
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Contacts-List-Avatar-Icon.svg" slot="start" shape="circle" class="avatar avatar_2"></igc-avatar>
                    <div>
                      <div class="column-layout group_7">
        ...
        <div class="column-layout group_4">
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item) => html`
                <igc-list-item>
                  <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" slot="start" class="avatar avatar_3"></igc-avatar>
                  <div>
                    <div class="column-layout group_7">
          ...
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item) => html`
                <igc-list-item>
                  <igc-avatar src="/src/assets/Tasks-Avatar-Icon.svg" slot="start" class="avatar avatar_4"></igc-avatar>
                  <div>
                    <div class="column-layout group_7">
