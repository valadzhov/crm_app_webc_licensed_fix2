            ...
            <igc-tab-panel class="column-layout tab-item-content">
              ...
              <igc-accordion ?single-expand="${true}" class="accordion">
                ...
                <igc-expansion-panel indicator-position="end">
                  <div class="column-layout group_9">
                    <div class="row-layout group_10">
                      <igc-avatar src="/src/assets/Account-List-Avatar-Icon.svg" shape="rounded" class="avatar_2"></igc-avatar>
                      <a class="typography__body-2 hyperlink">
                        Around The Horn
                      </a>
                    </div>
              ...
              <div class="column-layout group_15">
                ...
                <igc-accordion ?single-expand="${true}" class="accordion">
                  <igc-expansion-panel indicator-position="end">
                    <igc-list class="list">
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" slot="start" class="avatar_1 avatar_1_3"></igc-avatar>
                        <div>
                      ...
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" slot="start" class="avatar_1 avatar_1_4"></igc-avatar>
                        <div>
                          <div class="column-layout group_16">
                            <div class="row-layout group_17">
                              <p class="typography__subtitle-2 text_5">
                      ...
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" slot="start" class="avatar_1 avatar_1_5"></igc-avatar>
                        <div>
                          <div class="column-layout group_16">
                            <div class="row-layout group_17">
                              <p class="typography__subtitle-2 text_5">
